...
ALL : "$(OUTDIR)\mod_session_cookie.so"

!ELSE 

ALL : "mod_session - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_session_cookie.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_session_cookie.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_session_cookie.so" /implib:"$(OUTDIR)\mod_session_cookie.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_session_cookie.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_session - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_session_cookie.so"
...
ALL : "mod_session - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_session_cookie.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_session_cookie.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_session_cookie.so" /implib:"$(OUTDIR)\mod_session_cookie.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_session_cookie.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_session_cookie.obj" \
	"$(INTDIR)\mod_session_cookie.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_session - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_session_cookie.so"
...
"$(INTDIR)\mod_session_cookie.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_session_cookie.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_session_cookie.so" /d LONG_NAME="session_cookie_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_session_cookie.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_session_cookie.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_session_cookie.so" /d LONG_NAME="session_cookie_module for Apache" $(SOURCE)
