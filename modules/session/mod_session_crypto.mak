...
ALL : "$(OUTDIR)\mod_session_crypto.so"

!ELSE 

ALL : "mod_session - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_session_crypto.so"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"libhttpd - Win32 ReleaseCLEAN" "mod_session - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_session_crypto.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_session_crypto.so" /implib:"$(OUTDIR)\mod_session_crypto.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_session_crypto.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_session - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_session_crypto.so"
...
ALL : "mod_session - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_session_crypto.so"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"libhttpd - Win32 DebugCLEAN" "mod_session - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\mod_session_crypto.obj"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_session_crypto.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_session_crypto.so" /implib:"$(OUTDIR)\mod_session_crypto.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_session_crypto.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_session_crypto.obj" \
	"$(INTDIR)\mod_session_crypto.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_session - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_session_crypto.so"
...
"$(INTDIR)\mod_session_crypto.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_session_crypto.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_session_crypto.so" /d LONG_NAME="session_crypto_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_session_crypto.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_session_crypto.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_session_crypto.so" /d LONG_NAME="session_crypto_module for Apache" $(SOURCE)
