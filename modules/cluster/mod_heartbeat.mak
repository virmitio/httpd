...
ALL : "$(OUTDIR)\mod_heartbeat.so"

!ELSE 

ALL : "mod_watchdog - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_heartbeat.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_heartbeat.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_heartbeat.so" /implib:"$(OUTDIR)\mod_heartbeat.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_heartbeat.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_watchdog - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_heartbeat.so"
...
ALL : "mod_watchdog - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_heartbeat.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_heartbeat.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_heartbeat.so" /implib:"$(OUTDIR)\mod_heartbeat.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_heartbeat.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_heartbeat.obj" \
	"$(INTDIR)\mod_heartbeat.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_watchdog - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_heartbeat.so"
...
"$(INTDIR)\mod_heartbeat.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_heartbeat.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_heartbeat.so" /d LONG_NAME="heartbeat_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_heartbeat.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_heartbeat.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_heartbeat.so" /d LONG_NAME="heartbeat_module for Apache" $(SOURCE)
