...
ALL : "$(OUTDIR)\mod_authz_user.so"

!ELSE 

ALL : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_user.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_authz_user.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_authz_user.so" /implib:"$(OUTDIR)\mod_authz_user.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_authz_user.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_user.so"
...
ALL : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_user.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_authz_user.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_authz_user.so" /implib:"$(OUTDIR)\mod_authz_user.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_authz_user.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_authz_user.obj" \
	"$(INTDIR)\mod_authz_user.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_user.so"
...
"$(INTDIR)\mod_authz_user.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_user.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_authz_user.so" /d LONG_NAME="authz_user_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_authz_user.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_user.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_authz_user.so" /d LONG_NAME="authz_user_module for Apache" $(SOURCE)
