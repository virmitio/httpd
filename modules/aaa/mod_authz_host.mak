...
ALL : "$(OUTDIR)\mod_authz_host.so"

!ELSE 

ALL : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_host.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_authz_host.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_authz_host.so" /implib:"$(OUTDIR)\mod_authz_host.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_authz_host.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_host.so"
...
ALL : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_host.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_authz_host.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_authz_host.so" /implib:"$(OUTDIR)\mod_authz_host.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_authz_host.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_authz_host.obj" \
	"$(INTDIR)\mod_authz_host.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_host.so"
...
"$(INTDIR)\mod_authz_host.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_host.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_authz_host.so" /d LONG_NAME="authz_host_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_authz_host.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_host.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_authz_host.so" /d LONG_NAME="authz_host_module for Apache" $(SOURCE)
