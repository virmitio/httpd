...
ALL : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_core.so"
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_authz_core.so"
...
ALL : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_core.so"
...
$(DS_POSTBUILD_DEP) : "mod_auth_basic - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_authz_core.so"
...
"$(INTDIR)\mod_authz_core.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_core.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_authz_core.so" /d LONG_NAME="authz_default_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_authz_core.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_authz_core.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_authz_core.so" /d LONG_NAME="authz_default_module for Apache" $(SOURCE)
