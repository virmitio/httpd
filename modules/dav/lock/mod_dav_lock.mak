...
ALL : "mod_dav - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_dav_lock.so"
...
$(DS_POSTBUILD_DEP) : "mod_dav - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_dav_lock.so"
...
ALL : "mod_dav - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_dav_lock.so"
...
$(DS_POSTBUILD_DEP) : "mod_dav - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_dav_lock.so"
...
"$(INTDIR)\mod_dav_lock.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_dav_lock.res" /i "../../../include" /i "../../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_dav_lock.so" /d LONG_NAME="dav_lock_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_dav_lock.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_dav_lock.res" /i "../../../include" /i "../../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_dav_lock.so" /d LONG_NAME="dav_lock_module for Apache" $(SOURCE)
