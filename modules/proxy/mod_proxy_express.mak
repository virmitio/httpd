...
ALL : "mod_proxy - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_proxy_express.so"
...
$(DS_POSTBUILD_DEP) : "mod_proxy - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_proxy_express.so"
...
ALL : "mod_proxy - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_proxy_express.so"
...
$(DS_POSTBUILD_DEP) : "mod_proxy - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_proxy_express.so"
...
"$(INTDIR)\mod_proxy_express.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_proxy_express.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_proxy_express.so" /d LONG_NAME="proxy_balancer_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_proxy_express.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_proxy_express.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_proxy_express.so" /d LONG_NAME="proxy_balancer_module for Apache" $(SOURCE)
