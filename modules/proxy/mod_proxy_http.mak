...
ALL : "$(OUTDIR)\mod_proxy_http.so"

!ELSE 

ALL : "mod_proxy - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_proxy_http.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_proxy_http.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_proxy_http.so" /implib:"$(OUTDIR)\mod_proxy_http.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_proxy_http.so /opt:ref 
LINK32_OBJS= \
...
$(DS_POSTBUILD_DEP) : "mod_proxy - Win32 Release" "libhttpd - Win32 Release" "$(OUTDIR)\mod_proxy_http.so"
...
ALL : "mod_proxy - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_proxy_http.so"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib ws2_32.lib mswsock.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\mod_proxy_http.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\mod_proxy_http.so" /implib:"$(OUTDIR)\mod_proxy_http.lib" /base:@..\..\os\win32\BaseAddr.ref,mod_proxy_http.so 
LINK32_OBJS= \
	"$(INTDIR)\mod_proxy_http.obj" \
	"$(INTDIR)\mod_proxy_http.res" \
	"..\..\Release\libhttpd.lib" \
...
$(DS_POSTBUILD_DEP) : "mod_proxy - Win32 Debug" "libhttpd - Win32 Debug" "$(OUTDIR)\mod_proxy_http.so"
...
"$(INTDIR)\mod_proxy_http.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_proxy_http.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "NDEBUG" /d BIN_NAME="mod_proxy_http.so" /d LONG_NAME="proxy_http_module for Apache" $(SOURCE)
...
"$(INTDIR)\mod_proxy_http.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\mod_proxy_http.res" /i "../../include" /i "../../srclib/apr/include" /i "\tmp\httpd\build\win32" /d "_DEBUG" /d BIN_NAME="mod_proxy_http.so" /d LONG_NAME="proxy_http_module for Apache" $(SOURCE)
